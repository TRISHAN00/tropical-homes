...
const GoogleMapsMarkers = ({offset, full, dataMap, data, detail, gallery, slide, windowWidth, isBtn}) => {
    ...
    const {isLoaded} = useJsApiLoader({
        ...
        googleMapsApiKey: 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBFUqu_y_hrGr2t3B7HUmEZ_TEuw_CM9So=places',
        libraries: ['places']
    });
    ...
    useEffect(() => {
        if (mapRef.current) {
            // Access the map object and set it to the state
    ...
    const calculateRoute = async (customOrigin) => {
        const origin = customOrigin || currentLocation;
            ...
            <Col className={'p-0'} md={full ? 12 : 8} style={{height: '90vh'}} ref={mapRef}>
                {
                    ...
                    >
                        ...
                        <div onClick={() => calculateRoute(currentLocation)} className="direction">
                            <img src="/images/static/dir-icon.png" alt=""/>
                            <button  >
                                Direction
                            </button>
                        </div>
                            ...
                            {markers.map((marker) => (
                                <div key={marker.id} data-item={marker.id}
                                    ...
                                    <div className="content">
                                        ...
                                        {
                                            !isBtn &&   <Button color={'#F1EEE9'} icon_border={'#F1EEE9'}
